...
function Matrix(){
    ...
    <main class="d-flex flex-nowrap" >
      ...
      <div class="col themed-grid-col"><ToDoItems type="matrix" matrix = "Urgent and Important" style = {{color:"#337DFF"}}/></div>
      
      <div class="col themed-grid-col"><ToDoItems type="matrix" matrix = "Not Urgent and Unimportant" style = {{color:"#337DFF"}}/></div>
